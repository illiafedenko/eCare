import { faBagShopping, faGenderless, faLocationPin, faStar, faStarAndCrescent, faStarHalf, faStarHalfAlt, faStarHalfStroke, faStarOfDavid, faStarOfLife, faTransgender, faTransgenderAlt } from '@fortawesome/free-solid-svg-icons'
        ...
        <div className=' py-5 px-3 w-full flex flex-col gap-4'>
          <div className=' w-full flex flex-row justify-between'>
            ...
            <div className=' flex flex-col items-end py-2'>
              <p className=" text-[12px] h-[20px] text-center min-w-[90px] rounded-full bg-gray-200 px-2 font-medium text-green-600">Available</p>
            </div>
          </div>
          <div className=' w-full grid grid-cols-3 gap-2'>
            <div className=" text-[12px] h-[30px] flex flex-row justify-center items-center gap-2 rounded-full bg-gray-200 px-2 font-bold">
              ...
              <p className=' text-[12px] font-poppins font-bold'>{props.careGiver.location}</p>
            </div>
            <div className=" text-[12px] h-[30px] flex flex-row justify-center items-center gap-2 rounded-full bg-gray-200 px-2 font-bold">
              <FontAwesomeIcon className=' text-green-600 font-poppins font-bold' icon={faBagShopping} />
              <p className=' text-[12px] font-poppins font-bold'>{props.careGiver.role}</p>
            </div>
            <div className=" text-[12px] h-[30px] flex flex-row justify-center items-center gap-2 rounded-full bg-gray-200 px-2 font-bold">
              <FontAwesomeIcon className=' text-green-600 font-poppins font-bold' icon={faTransgenderAlt} />
              <p className=' text-[12px] font-poppins font-bold'>{props.careGiver.gender}</p>
            </div>
          </div>
