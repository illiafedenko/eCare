...
import AdminSettingNormalInfo from './AdminSettingNormalInfo';
import AdminSettingChangePassword from './AdminSettingChangePassword';
...
export default function AdminSetting() {
  ...
  return (
    <div className=" w-full h-screen flex flex-row relative ">
      <SideBar portalname="aportal" menu={dummyData.AMenu} current="setting" />
            ...
            <div className=' w-full flex flex-col max-w-[800px] gap-y-10'>
              ...
              <div>
                <div className={`${currentTap == 0 ? '' : ' hidden'}`}>
                  <AdminSettingNormalInfo />
                </div>
                <div className={`${currentTap == 1 ? '' : ' hidden'}`}>
                  <AdminSettingChangePassword />
                </div>
              </div>
            </div>
          </div>
