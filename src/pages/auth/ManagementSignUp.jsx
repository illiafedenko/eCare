...
import imageSrc from '../../assets/images/CGM2.png';
...
export default function ManagementSignUp() {
  ...
  const handleSubmitEvent = (e) => {
    ...
    console.log(input);
    var tableName = input.role == "OM" ? "officeManagers" : "humanResources";
    ...
    <div className=" relative py-[26px] px-[50px] h-screen w-full">
      <div className='grid grid-cols-1 xl:grid-cols-2 gap-[17px] h-[calc(100vh-52px)]'>
        ...
        <div className=" w-full  pt-3 lg:px-[48px] lg:py-0 ">
          ...
          <div className='my-4 w-full'>
            <p className='mb-2 text-left text-gray-500 font-poppins' >Select Role <span className=' text-red-600'>*</span></p>
            <select onChange={handleChange} name="role" className="appearance-none rounded-[4px] w-full py-3 px-3 focus:border-blue-500 border-[2px] text-gray-700 leading-tight focus:outline-none focus:shadow-outline ">
